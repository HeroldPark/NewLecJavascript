...
window.addEventListener("load", function(){
    ...
    allCheckbox.onchange = function(){
        //console.log(allCheckbox.value); // 여기서는 맞지 않다.
        //console.log(allCheckbox.checked);   // true or false
    ...
    delButton.onclick = function(){
        ...
        //console.loh(inputs.length);
        // if(inputs[0].checked)
        //     inputs[0].parentElement.parentElement.remove();

        for(var i=0; i<inputs.length; i++)
            inputs[i].parentElement.parentElement.remove(); // <tr> 태그를 선택해서 삭제한다.
    };
...
window.addEventListener("load", function(){
    ...
    downButton.onclick = function(){
        ...
        //tbodyNode.removeChild(nextNode);  // 없어도 달 된다.
    ...
    upButton.onclick = function(){
        ...
        //tbodyNode.removeChild(currentNode);   // 없어도 달 된다.
...
window.addEventListener("load", function(){
    ...
    cloneButton.onclick = function(){
        ...
        tds[1].textContent = '<a href="'+notice[0].id+'">'+notice[0].title;
...
window.addEventListener("load", function() {    // 이벤트를 누적한다.
...
window.addEventListener("load", function() {    // 이벤트를 누적한다.
    ...
    changeButton.onclick = function() {
        ...
        //img.style.border-color = ?  // 안된다.
        //img.style["border-color"] = colorInput.value;
        // 위와 같은 결과
        img.style.borderColor = colorInput.value;
        console.log(img.className); // img.class 은 사용 안됨.
    }
});
